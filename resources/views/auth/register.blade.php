<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role_id:{{old('role') ?? 0}}}">
            @csrf
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" autofocus autocomplete="name" placeholder="eg. johndoe"/>
            </div>
            ...
            <div class="block mt-4 text-center">
                <x-jet-button class="mt-2 w-full bg-indigo-700 hover:bg-indigo-800" onclick="this.disabled=true;this.form.submit();">
                    {{ __('Register')}}
                </x-jet-button>
            </div>
        </form>
