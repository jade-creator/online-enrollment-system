<x-app-layout>
    <div class="p-5 h-full w-full overflow-y-auto scrolling-touch">
        <div x-data="{component: 'index'}" class="w-full mb-6 pt-3">
             <div x-show.transition.in.opacity.duration.750ms="component === 'index'">
                 <div class="flex flex-row items-center justify-between mb-4">
                     <div class="flex flex-col">
                         <div class="text-xs uppercase font-light text-gramy-500">Overview</div>
                         <div class="text-xl font-bold">Dashboard</div>
                     </div>
                     <div class="flex-shrink-0 space-x-2">
                         
                         <button @click="component = 'create'" type="submit" class="btn btn-default bg-blue-500 hover:bg-blue-600 text-white py-2.5 px-4 font-bold text-xs rounded-lg flex">
             ...
             <div x-show.transition.in.opacity.duration.750ms="component === 'create'">
                 {{-- @include('create') --}}
