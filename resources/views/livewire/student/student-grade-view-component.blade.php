                    ...
                    <div id="{{ $registration->id }}" x-data="{ open: false }">
                        <div @click="open = ! open" 
                            ...
                            <div class="grid grid-cols-12 gap-2">
                                ...
                                <div class="flex items-center justify-start col-span-12 md:col-span-3 truncate md:border-0 border-t border-gray-300 font-bold text-xs">{{ $registration->student->isStudent ? $registration->student->custom_student_id : '--' }}</div>
