<x-table.nested-row>
    <x-slot name="nestedTable">
        ...
        <div class="py-4 hidden md:grid grid-cols-12 gap-2 px-4 bg-indigo-500">
            ...
            <x-table.column-title class="col-span-2"><span class="text-white">professor</span></x-table.column-title>
            <x-table.column-title class="col-span-1"><span class="text-white">day</span></x-table.column-title>
        ...
        <div class="grid grid-cols-12 md:gap-2 px-4 py-4 md:py-0">
            @forelse ($section->schedules as $schedule)
                ...
                <x-table.cell headerLabel="Professor" class="md:col-span-2">{{ $schedule->employee->user->person->full_name ?? 'N/A' }}</x-table.cell>
