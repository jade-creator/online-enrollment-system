            ...
            <x-slot name="filter">
                <x-table.filter>
                    <x-table.filter-slot title="Status">
                        <select wire:model="statusId" wire:loading.attr="disabled" id="status" aria-label="statuses">
                    ...
                    <div wire:key="table-row-{{$registration->id}}">
                        <x-table.row>
                            <div name="slot" class="grid grid-cols-12 gap-2">
                                ...
                                <x-table.cell class="justify-start md:col-span-2">{{ $registration->status->name ?? 'N/A' }}</x-table.cell>
