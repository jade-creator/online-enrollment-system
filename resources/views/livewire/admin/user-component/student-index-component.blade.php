    ...
    <div class="h-content w-full p-4 md:p-8">
        ...
        <x-table.main>
            ...
            <x-slot name="head">
                ...
                <x-table.column-title class="col-span-3">user account</x-table.column-title>
                <x-table.column-title class="col-span-3">grand total</x-table.column-title>
                <x-table.column-title class="col-span-3">running balance</x-table.column-title>
                    ...
                    <div wire:key="table-row-{{$student->id}}">
                        <x-table.row :active="$this->isSelected($student->id)">
                            <div name="slot" class="grid grid-cols-12 md:gap-2">
                                ...
                                <x-table.cell headerLabel="user" class="justify-start md:col-span-3 md:flex items-center">
                                ...
                                <x-table.cell headerLabel="Grand total" class="justify-start md:col-span-3">{{ 'PHP 12,212' }}</x-table.cell>
                                <x-table.cell headerLabel="Running Balance" class="justify-start md:col-span-3">{!! 'PHP 9,212' !!}</x-table.cell>
                                <x-table.cell-action>
                                    @if (!count($selected) > 0)
