        ...
        <x-table.main>
            ...
            <x-slot name="body">
                @forelse ($specializations as $specialization)
                    <div class="w-full p-2 my-1 rounded-md shadow hover:shadow-md @if ($this->isSelected($specialization->id)) bg-gray-200 @else bg-white @endif border-t border-l border-r border-gray-200 border-opacity-80">
                ...
                @empty  
                    <x-table.no-result title="No specialization found.🤔"/> 
                @endforelse
            </x-slot>
        </x-table.main>
