<div class="flex-grow bg-white shadow-md pt-8 px-5 text-gray-500">
    <h3 class="mb-8 font-bold text-lg">{{ __('Filters')}}</h3>
    {{-- <div class="flex border-b border-gray-200 pb-3 mb-6 transition-all duration-500 focus-within:border-gray-300">
        ...
        <input type="text" wire:model="search" placeholder="Search..." class="bg-white border-0 focus:outline-none focus:ring focus:ring-gray-100 focus:ring-opacity-0">            
    </div> --}}
